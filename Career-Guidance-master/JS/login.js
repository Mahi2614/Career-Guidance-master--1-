...
$(function () {
  $("form[name='login']").validate({
    ...
    submitHandler: function (form) {
      window.location.href = 'Career-Guidance-master/interest.html' // Redirect to interest.html after successful login
    },
  })
})
...
$(document).ready(function () {
  $('#signInn').click(function (event) {
    ...
    // window.location.href = 'interest.html' // Commented out to prevent premature redirection
